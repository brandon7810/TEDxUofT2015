...
angular.module('tedxUofT2015App')
  .controller('VideoCtrl', ["$scope", "$window", "$sce", "$rootScope", function ($scope,$window,$sce,$rootScope) {
	...
	$scope.videos = [
      ...
      link  : "http://www.youtube.com/embed/HsNP1L-hMqs",
			id  : "HsNP1L-hMqs",
      speaker : "Marcel Danesi",
		...
		{
      title : "Without a leg to stand on -- 3D printing prosthetics",
      link  : "http://www.youtube.com/embed/LNohxpJntZo",
			id  : "LNohxpJntZo",
      speaker : "Matt Ratto",
      ...
      link  : "http://www.youtube.com/embed/CuxfRdjfZG0",
			id : "CuxfRdjfZG0",
      speaker :  "Steve Easterbrook",
		...
		{
      title : "Innovation -- taking time to fail",
      link  : "http://www.youtube.com/embed/tl5GbgP1EFM",
			id : "tl5GbgP1EFM",
      speaker : "Cameron Robertson & Todd Reichert",
		...
		{
      title : "How digital media and big data are redefining democracy",
      link  : "http://www.youtube.com/embed/6a59mBqyZaU",
			id  : "6a59mBqyZaU",
      speaker : "Clifton Van Der Linden",
		...
		{
      title : "Extreme manipulation of electromagnetic waves with metamaterials",
      link : "http://www.youtube.com/embed/LFxQEUDIAuk",
			id  : "LFxQEUDIAuk",
      speaker : "George Eleftheriades",
		...
		{
      title : "Why we all need to become more human",
      link  : "http://www.youtube.com/embed/0sxY-jS7v3U",
			id  : "0sxY-jS7v3U",
      speaker : "Greg Wells",
		...
		{
      title : "The Science Fair effect -- how youths are reinventing our world",
      link  : "http://www.youtube.com/embed/GYzLcpN8dso",
			id  : "GYzLcpN8dso",
      speaker : "Jessie MacAlpine",
        ...
        Three years ago, Jessie developed an herbicide composed of used coffee grounds and an invasive Canadian weed species. After coming across \
		...
		{
      title : "It's time to re-evaluate our relationship with animals",
      link  : "http://www.youtube.com/embed/Fr26scqsIwk",
			id  : "Fr26scqsIwk",
      speaker : "Lesli Bisgould",
		...
		{
      title:  "In defence of the generalist in a specialists' world",
      link  : "http://www.youtube.com/embed/a70HvvdGOrQ",
			id  : "a70HvvdGOrQ",
      speaker : "Sarah Kenvyn",
		...
		{
      title : "The Dark Side of the Chew",
      link  : "http://www.youtube.com/embed/Myce8GLcJsQ",
			id  : "Myce8GLcJsQ",
      speaker : "Andrew Nisker",
      ...
      link  :   "http://www.youtube.com/embed/97Qr8TEcHj8",
			id  : "97Qr8TEcHj8",
      speaker : "Jessy Je Young Kim, Christina Choi, Tess Crowther",
		...
		{
      title : "Epic Song Mashup",
      link  : "http://www.youtube.com/embed/u_RJhOEaiCY",
			id  : "u_RJhOEaiCY",
      speaker : "Tunes. Beats. Awesome.",
